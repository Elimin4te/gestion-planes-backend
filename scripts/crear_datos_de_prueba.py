...
def crear_si_no_existe(entidad: Model, campo_pk, valor_pk: str, datos: dict):
    ...
    if creado:
        print(f"{entidad.__class__.__name__} {valor_pk} creado(a) exitosamente.")
    else:
        print(f"{entidad.__class__.__name__} {valor_pk} ya existía.")
...
def crear_plan_aprendizaje(docente: Docente, uc: UnidadCurricular, pnf: str):
    ...
    codigo_grupo = f"{pnf}-{uc.codigo}-{nucleo}-{turno} ({año}-{año + 1})"
...
def crear_objetivo_pa(
    ...
    estrategia_didatica = opcion_aleatoria(OPCIONES_ESTRATEGIAS_DIDACTICAS)
...
def crear_plan_evaluacion(pa: PlanAprendizaje):
    ...
    titulo = f"P.E de {pa.nombre_uc} ({pa.codigo_grupo})"
...
def run():
    ...
    data_objetivos_mat1 = [
        {
            "titulo": "Comprender los conceptos básicos del álgebra",
        ...
        {
            "titulo": "Dominar las operaciones con funciones",
        ...
        {
            "titulo": "Aplicar el concepto de límite de una función",
        ...
        {
            "titulo": "Calcular derivadas de funciones",
        ...
        {
            "titulo": "Resolver problemas de aplicación de cálculo",
    ...
    data_objetivos_fc1 = [
        {
            "titulo": "Identificar y analizar argumentos",
        ...
        {
            "titulo": "Evaluar la credibilidad de las fuentes",
        ...
        {
            "titulo": "Reconocer y evitar los sesgos cognitivos",
        ...
        {
            "titulo": "Aplicar el pensamiento crítico a problemas sociales",
    ...
    data_objetivos_ayp = [
        {
            "titulo": "Comprender los fundamentos de la algorítmica",
        ...
        {
            "titulo": "Dominar las estructuras de control",
        ...
        {
            "titulo": "Aplicar el concepto de funciones",
        ...
        {
            "titulo": "Manejar arreglos y listas",
        ...
        {
            "titulo": "Implementar algoritmos de búsqueda y ordenamiento básicos",
